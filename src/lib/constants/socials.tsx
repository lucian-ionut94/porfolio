...
export const SOCIAL_LINKS: SocialLink[] = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/luccianwww/",
    icon: (
  ...
  {
    name: "GitHub",
    href: "https://github.com/lucian-ionut94",
    icon: (
      <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/lucian.ionut.25/",
    icon: (
      <svg className="w-[18px] h-[18px]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
/** Facebook page URL used for og:article:publisher */
export const FACEBOOK_PAGE_URL = "https://www.facebook.com/lucian.ionut.25/";
